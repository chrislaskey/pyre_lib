defmodule PyreWeb.WebhookControllerTest do
  ...
  setup do
    previous_config = Application.get_env(:pyre, :config)
    ...
    on_exit(fn ->
      Application.put_env(:pyre, :config, previous_config)
  ...
  describe "authorization" do
    test "rejects when authorize_webhook returns error", %{conn: conn} do
      Application.put_env(:pyre, :config, PyreWeb.WebhookControllerTest.DenyWebhooks)
